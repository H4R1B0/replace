...
Files: PayPhone.glb [538.15KB] > PayPhone-transformed.glb [75.76KB] (86%)
*/
...
type GLTFResult = GLTF & {
  nodes: {
    ...
    PayPhoneBooth_1: THREE.Mesh;
    PayPhoneBooth_2: THREE.Mesh;
  };
  materials: {
...
export default function Payphone({ onPayphoneClick, ...other }: PayphoneProps) {
  ...
  return (
    <group {...other} dispose={null}>
      ...
      >
        <mesh
          geometry={nodes.PayPhoneBooth_1.geometry}
          material={materials.PaletteMaterial002}
        />
        <mesh
          geometry={nodes.PayPhoneBooth_2.geometry}
          material={materials.PaletteMaterial001}
        />
      </group>
    </group>
