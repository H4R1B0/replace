...
public interface VoicemailRepository extends JpaRepository<Voicemail, Long> {
    ...
    @Query("select new com.vegetable.samochiro.dto.voicemail.VoicemailItem(v.id, v.sendDate, v.fromUser.nickname, v.url) from Voicemail v where v.toUser.id=:userId")
